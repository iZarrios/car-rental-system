            ...
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs"><span class="mr-2"><a href="../admin/admin.php">Home <i
                                    class="ion-ios-arrow-forward"></i></a></span> <span>View Cars<i
  ...
  width: 30%;" src="<?= URL . "uploads/images/cars/" . $car['plate_id'] . ".jpg" ?>" alt="Car of The Image"></td>
                        ...
                        <td class="text-center">
                            <a class="btn btn-primary"
                                href="<?= URL . "views/car/Edit_car.php?plate_id=" . $car['plate_id'] ?>"
                                role="button">Edit</a>
                            <a class="btn btn-danger"
                                href="<?= URL . "handlers/car/delete.php?plate_id=" . $car['plate_id'] ?>"
