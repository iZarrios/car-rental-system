        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs"><span class="mr-2"><a href="../admin/admin.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Delete Car <i class="ion-ios-arrow-forward"></i></span></p>
        ...
        <div class="container">
            <div class="row d-flex mb-5 contact-info">
                ...
                <div class="col-md-8 block-9 mb-md-5">
                    ...
                    <form class="bg-light p-5 contact-form" method="GET" action="<?= URL . "handlers/car/delete.php" ?>">
                        <div class="form-group">
                            <input type="text" name="plate_id" id="plate_id" class="form-control" placeholder="Plate ID" required>
                        </div>
