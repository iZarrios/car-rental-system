            ...
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs"><span class="mr-2"><a href="../admin/admin.php">Home <i
                                    class="ion-ios-arrow-forward"></i></a></span> <span>Advanced Search<i
        ...
        <div class="container">
            ...
            <div class="row d-flex mb-5 contact-info">
                <div class="col-md-8 block-9 mb-md-5">
                    ...
                    <form class="form1 bg-light p-5 contact-form" name="myform1" id="myform1"
                        action="<?= URL . "handlers/admin/search.php"; ?>" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="lower_bdate" id="lower_bdate" placeholder="Start Date"
                                value="1930-01-01" required>
                            <label for="html">To:</label>
                            <input type="date" name="upper_bdate" id="upper_bdate" placeholder="End Date"
                                value="2022-12-31" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="lower_date" id="plate_id" placeholder="Start Date"
                                value="1990-01-01" required>
                            <label for="html">To:</label>
                            <input type="date" name="upper_date" id="brand" placeholder="End Date" value="2030-12-31"
                                required>
                        </div>
                        <br>
            ...
            <table class=" table table-bordered text-center table-hover" style="width:100%">
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td style="font-size: 9px;"> <?php echo $car["gender"] ?></td>
