            ...
            <div style="width: 50%; height: 550px; float:left;">
                <div class="container" style="position:relative; left:180px; top:2px;">
                    ...
                    <form method="POST" action="<?= URL . "handlers/balance/credit_card.php"; ?>">
                        <h1>Payment Information</h1><label for="user_id">User id:</label><br>
                        ...
                        <input type="number" placeholder="YYYY" min="1999" max="2020" id="expiration_year" name="expiration_year" placeholder="year"><br>
