    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 ftco-animate">
          ...
          <h5><a href="Edit_User.php" class="nav-link">Edit my Information</a></h5>
          <h5><a href="Rental_history.php" class="nav-link">Rental history</a></h5>
          <h5><a href="Rental_reservations.php" class="nav-link">Rental reservations</a></h5>
