        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 ftco-animate">
                    ...
                    <form class="form1" name="form" id="form" method="POST"
                        action="<?= URL . "handlers/auth/update.php" ?>">
                        <!-- <div>
              <input class="un " type="text" name="user_id" id="user_id" placeholder="User_id" value="<?= $_SESSION['logged']['user_id'] ?>" />
                        ...
                        <div class="d-flex">
                            ...
                            <br />
                            <input class="un " disabled="disabled" type="text" name="pass" id="pass"
                                placeholder="password" value="<?= $_SESSION['logged']['password'] ?>" />
                            <br />
                        </div>
                        <div class="d-flex">
                            <input class="un " type="country" name="country" id="country" placeholder="Country"
                                value="<?= $_SESSION['logged']['country'] ?>" />
                            <input class="un " type="city" name="city" id="city" placeholder="City"
                                value="<?= $_SESSION['logged']['city'] ?>" />

                        </div>
                        <div class="d-flex">
                            <!-- <input class="un " type="city" name="city" id="city" placeholder="City" value="<?= $_SESSION['logged']['city'] ?>" />  -->
                            <input class="un " disabled="disabled" type="date" name="bdate" id="bdate"
                                placeholder="bdate" value="<?= $_SESSION['logged']['bdate'] ?>" />
                            <?php
              if ($_SESSION['logged']['gender'] == 1) {
              ?>
                            <input class="un " disabled="disabled" type="text" name="gender" id="gender"
