                ...
                <div class="col-md-8 block-9 mb-md-5">
                    <form class="bg-light p-5 contact-form" action="<?= URL . "handlers/reports/r1.php"; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="lower_date" id="lower_date.png" class="form-control" placeholder="yyyy-mm-dd" value='' required>
                        </div>

                        <div class="form-group">
                            <label for="html">To:</label><br>
                            <input type="text" name="upper_date" id="upper_date" class="form-control" placeholder="yyyy-mm-dd" required>
                        </div>
