                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu ml-auto" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="../reports/report2.php"
                                    class="nav-link active">Report2</a></li>
                ...
                <div class="col-md-8 block-9 mb-md-5">
                    <form class="bg-light p-5 contact-form" action="<?= URL . "handlers/reports/r2.php"; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="lower_date" id="plate_id" class="form-control"
                                placeholder="Start Date" required>
                        </div>

                        <div class="form-group">
                            <label for="html">To:</label><br>
                            <input type="text" name="upper_date" id="brand" class="form-control" placeholder="End Date"
                                required>
                        </div>
