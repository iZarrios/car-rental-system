        ...
        <div class="row">
          <div class="col-md-4">
            <div class="car-wrap rounded ftco-animate">
              <div
                ...
                style="background-image: url(../../public/images/car-1.jpg)"
              ></div>
              <div class="text">
                <h2 class="mb-0">
                ...
                <p class="d-flex mb-0 d-block">
                  ...
                  <a href="car-single.php" class="btn btn-secondary py-2 ml-1"
                    >Details</a
                  >
                </p>
              </div>
          ...
          <div class="col-md-4">
            <div class="car-wrap rounded ftco-animate">
              <div
                class="img rounded d-flex align-items-end"
                style="background-image: url(../../public/images/car-2.jpg)"
              ></div>
              <div class="text">
          ...
          <div class="col-md-4">
            <div class="car-wrap rounded ftco-animate">
              <div
                class="img rounded d-flex align-items-end"
                style="background-image: url(../../public/images/car-3.jpg)"
              ></div>
              <div class="text">
                <h2 class="mb-0">
                  <a href="car-single.php">Mercedes Grand Sedan</a>
