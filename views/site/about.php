  ...
  <section class="ftco-section ftco-about">
    <div class="container">
      <div class="row no-gutters">
        <div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(../../public/images/about.jpg)"></div>
        <div class="col-md-6 wrap-about ftco-animate">
          <div class="heading-section heading-section-white pl-md-5">
            ...
            <p>
              <a href="../site/car.php" class="btn btn-primary py-3 px-4">Search Vehicle</a>
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="carousel-testimony owl-carousel ftco-owl">
            <div class="item">
              <div class="testimony-wrap rounded text-center py-4 pb-5">
                <div class="user-img mb-2" style="background-image: url(../../public/images/person_1.jpg)"></div>
                <div class="text pt-4">
                  <p class="mb-4">
                    It was a great to rent a car from your office, will try it
                    again later.
                  </p>
                  <p class="name">Max Scott</p>
                  <span class="position">ceo at xyz </span>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="testimony-wrap rounded text-center py-4 pb-5">
                <div class="user-img mb-2" style="background-image: url(../../public/images/person_2.jpg)"></div>
                <div class="text pt-4">
                  <p class="mb-4">
                    thanks for your services, with out you service , I would
                    have been lost.
                  </p>
                  <p class="name">Sam Scott</p>
                  <span class="position">famous Designer</span>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="testimony-wrap rounded text-center py-4 pb-5">
                <div class="user-img mb-2" style="background-image: url(../../public/images/person_3.jpg)"></div>
                <div class="text pt-4">
                  <p class="mb-4">
                    thanks for covering cars for my last concert.
                  </p>
                  <p class="name">John Scott</p>
            ...
            <div class="item">
              <div class="testimony-wrap rounded text-center py-4 pb-5">
                <div class="user-img mb-2" style="background-image: url(../../public/images/person_1.jpg)"></div>
                <div class="text pt-4">
                  <p class="mb-4">Great Service, Wish you the best.</p>
      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <p>
              A new car rent office which provide multiple types of car to rent starting from low end to high end and luxurious cars .
            </p>
