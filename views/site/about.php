            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5">
                  <div
                    class="user-img mb-2"
                    style="background-image: url(../../public/images/person_1.jpg)"
                  ></div>
                  <div class="text pt-4">
                    <p class="mb-4">
              ...
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5">
                  <div
                    class="user-img mb-2"
                    style="background-image: url(../../public/images/person_2.jpg)"
                  ></div>
                  <div class="text pt-4">
                    <p class="mb-4">
              ...
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5">
                  <div
                    class="user-img mb-2"
                    style="background-image: url(../../public/images/person_3.jpg)"
                  ></div>
                  <div class="text pt-4">
                    <p class="mb-4">
